...
_parseSelect:function(){var b=this,c="";// if we have groups
// parse each group separately
// if we don't have groups
// just parse the elements regularly
return this.element.find("optgroup").length?this.element.find("optgroup").each(function(){c+='<li class="'+b.options.class_group+'">'+a(this).attr("label")+"</li>",c+=b._parseElements(a(this).html())}):c=this._parseElements(this.element.html()),c},
// turn option elements into li elements
// elhtml - HTML containing the options
_parseElements:function(b){var c=this,d="";
// spit it out
// go through each option
return a(a.trim(b)).filter("option").each(function(){var b=a(this);""===b.attr("value")&&c.options.remove_empty_option||(
